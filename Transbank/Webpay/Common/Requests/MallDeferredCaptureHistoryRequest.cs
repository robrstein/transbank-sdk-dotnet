...
{
    internal class MallDeferredCaptureHistoryRequest : BaseRequest
    {
        ...
        internal MallDeferredCaptureHistoryRequest(string token, string buyOrder, string commerceCode = null) :
