...
{
    internal class MallReversePreAuthorizedAmountRequest : BaseRequest
    {
        ...
        internal MallReversePreAuthorizedAmountRequest(string token, string buyOrder, string authorizationCode,
            decimal amount, string commerceCode = null) : 
            base($"{Constant.WEBPAY_METHOD}/transactions/{token}/reverse/amount", HttpMethod.Put)
        {
            BuyOrder = buyOrder;
